...
class DiagnosticSystem:
    ...
    def _calculate_information_gain(self, symptom, candidate_diseases):
        ...
        if with_symptom > 0:
            conditional_entropy += (with_symptom / total) * -math.log2(with_symptom / total)
        if without_symptom > 0:
            conditional_entropy += (without_symptom / total) * -math.log2(without_symptom / total)
